...
summary: As part of the L4 Data Analysis Bootcamp with Cambridge Spark, I completed several assignments to test my knowlegde. This was a Data Cleansing Assignment. #shows on the homepage
date: 2024-04-29
...
![screen reader text](Screenshot-3.png) 
...
``` 
![screen reader text](Screenshot-4.png)
...
def convert_to_float(x):
    try: 
        ...
        return np.nan 
``` 
![screen reader text](Screenshot-5.png)
...
![screen reader text](Screenshot-6.png)
...
![screen reader text](Screenshot-7.png)
...
![screen reader text](Screenshot-9.png)
...
![screen reader text](Screenshot-10.png)
...
![screen reader text](Screenshot-11.png)
